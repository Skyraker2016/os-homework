...
ProgramList program_lists[PROGRAM_SIZE] ={
                    {0x4000, 0x10000, 0x4000, "TO UPPER", 0},
                    {0x8000, 0x18000, 0x4000, "ANY STRING", 0},
                    {0xC000, 0x20000, 0x4000, "COLORFUL A", 0},
                    {0x10000, 0x28000, 0x4000, "SNAKE", 0},
                    {0x14000, 0x30000, 0x4000, "ASCII", 0}
                };
